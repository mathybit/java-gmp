...
import static pca.cs.jna.gmp.LibGMP.__gmpz_import;
import static pca.cs.jna.gmp.LibGMP.__gmpz_export;
import static pca.cs.jna.gmp.LibGMP.readSizeT;

import static pca.cs.jna.gmp.LibGMP.__gmpz_init;
import static pca.cs.jna.gmp.LibGMP.__gmpz_clear;
import static pca.cs.jna.gmp.LibGMP.__gmpz_cmp_si;
import static pca.cs.jna.gmp.LibGMP.__gmpz_add;
import static pca.cs.jna.gmp.LibGMP.__gmpz_sub;
import static pca.cs.jna.gmp.LibGMP.__gmpz_mul;
import static pca.cs.jna.gmp.LibGMP.__gmpz_tdiv_q;//quotient
import static pca.cs.jna.gmp.LibGMP.__gmpz_tdiv_r;//remainder
import static pca.cs.jna.gmp.LibGMP.__gmpz_neg;
import static pca.cs.jna.gmp.LibGMP.__gmpz_divexact;
import static pca.cs.jna.gmp.LibGMP.__gmpz_gcd;
import static pca.cs.jna.gmp.LibGMP.__gmpz_powm;
import static pca.cs.jna.gmp.LibGMP.__gmpz_powm_sec;
import static pca.cs.jna.gmp.LibGMP.__gmpz_invert;
import static pca.cs.jna.gmp.LibGMP.__gmpz_legendre;
import static pca.cs.jna.gmp.LibGMP.__gmpz_jacobi;
import static pca.cs.jna.gmp.LibGMP.__gmpz_probab_prime_p;
import static pca.cs.jna.gmp.LibGMP.__gmpz_nextprime;
